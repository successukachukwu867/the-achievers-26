...
app.post('/submit', upload.single('photo'), async (req, res) => {
  try {
    ...
    // Return blurred preview as base64 + success message
    const previewB64 = pngBuffer.toString('base64');
    res.json({ ok: true, preview: `data:image/png;base64,${previewB64}`, name: data.fullName });
  } catch (err) {
    console.error(err);
